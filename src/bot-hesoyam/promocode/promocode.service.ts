...
export class PromocodeService {
  constructor(
    @InjectRepository(PromocodeHesoyam)
    private promocodeRepository: Repository<PromocodeHesoyam>,
  ) {}

  async create(dto: CreateDto = {}): Promise<PromocodeHesoyam> {
    try {
  ...
  async update({ id, field, ...dto }: UpdateDto): Promise<PromocodeHesoyam> {
    try {
  ...
  async findOne({
    ...
    name,
    is_published = null,
  }: GetDto): Promise<PromocodeHesoyam> {
