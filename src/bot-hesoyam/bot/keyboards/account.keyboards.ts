...
export const admins = ['andrew_kk', 'rymar', 'tomera_study', 'tomeraroman'];
...
const getAccountTitle = (user: UserHesoyam) => {
...
const getAccountLanguage = (user: UserHesoyam) => {
  switch (user.language) {
    case UserLanguageEnum.EN:
      return `🌎 Language`;
...
// const getAccountTimezone = (user: UserHesoyam) => {
//   switch (user.language) {
//     case UserLanguageEnum.EN:
//       return `Timezone`;
...
const getAccountEmail = (user: UserHesoyam) => {
  switch (user.language) {
    case UserLanguageEnum.EN:
      return `📧 Email`;
