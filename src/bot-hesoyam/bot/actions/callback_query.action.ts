...
export const actionCallbackQuery = async (
  ...
  Внимание необходимо присоединиться ко всем каналам и чатам в течение 24 часов после получения ссылок!`,
          ...
          await bot.sendMessage(
            customer.chat_id,
            customer.language === UserLanguageEnum.UA
              ? `✅ Менеджер підтвердив вашу оплату! Дякуємо що довірилися нам. Скоро з вами зв'яжеться менеджер. Якщо є питання звертайтеся до @tomera_study`
              : `✅ Менеджер подтвердил вашу оплату! Спасибо что доверились нам. Скоро с вами свяжется менеджер. Если есть вопросы, обратитесь к @tomera_study`,
          );
        }
      }
